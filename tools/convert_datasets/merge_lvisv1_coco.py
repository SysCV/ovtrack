...
# The original code is from https://github.com/xingyizhou/GTR/blob/master/tools/merge_lvis_coco.py
# install detectron2 to run this script
...
COCO_PATH = 'data/lvis/annotations/instances_train2017.json'
IMG_PATH = 'data/lvis/train2017/'
